...
const SingleMovie = () => {
  ...
  return (
    <>
      ...
      {/* <AddComment userId={user.id} movieId={params.id} />
      <Comment username="John Doe" rating={5} comment="Amazing product! Highly recommended." />
      <Comment username="Alice" rating={4} comment="Great service but delivery was slow." />
      <Comment username="Bob" rating={3} comment="Good, but could be improved." /> */}
      </div>
    </>
  );
};
